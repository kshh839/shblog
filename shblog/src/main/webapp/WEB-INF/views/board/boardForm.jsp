...
<meta charset="UTF-8">
<title>board</title>
<script defer src="https://cdn.ckeditor.com/ckeditor5/41.2.1/classic/ckeditor.js"></script> <!-- CKEditor5 -->
<script defer src="${pageContext.request.contextPath}/resources/common/js/ckeditor.js"></script> <!-- CKEditor5 설정 파일 -->
<script>
